    ...
    if (username === "" || phoneNumber === "" || email === "" || subject === "" || message === "") {
      ...
      emailjs.send('service_ske2w43', 'template_tz4y1rp', {
        ...
        .then((response) => {
          ...
          setErrMsg("Email failed to send, please try again later");
        });
    }
  };
  return (
        ...
        <div className="w-full h-auto flex flex-col lgl:flex-row justify-between">
          ...
          <div className="w-full lgl:w-[60%] h-full py-10 bg-gradient-to-r from-[#1e2024] to-[#23272b] flex flex-col gap-8 p-4 lgl:p-8 rounded-lg shadow-shadowOne">
            <form className="w-full flex flex-col gap-4 lgl:gap-6 py-2 lgl:py-5">
              ...
              {errMsg && (
                <p className="py-3 bg-gradient-to-r from-[#1e2024] to-[#23272b] shadow-shadowOne text-center text-yellow-500 text-base tracking-wide animate-bounce">
                  {errMsg}
                </p>
              )}
              {successMsg && (
